...
$datakode = mysqli_fetch_array($carikode);
if(isset($datakode[0]) && $datakode[0]) { // Perbaikan: pastikan index ada
...
if(isset($_POST['tambah'])){
    ...
    // jika id_kelas diambil dari input format "K-001", ekstrak angka agar sesuai tipe integer
    if (is_string($id_kelas) && strpos($id_kelas, 'K-') === 0) {
        $id_kelas = (int)substr($id_kelas, 2);
    }
